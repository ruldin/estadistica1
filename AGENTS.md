...
- [Estadistica1/sem9_agrupados.html](file:///d:/U/2026/Semestre2/Estadistica/WebAppEstadistica/Estadistica1/sem9_agrupados.html): Semana 9 — Estadígrafos de Tendencia Central para Datos Agrupados y Medidas de Posición: Guía interactiva integral con **banner ejecutivo colapsable del Caso Práctico Gerencial Cooperativa "El Ahorro Pinulteco"** (San José Pinula: 50 microcréditos para responder al Gerente General con Media x̄, Tercer Cuartil Q3 y Percentil 90 P90, con guía paso a paso y carga automática a la Ficha del Estudiante), tabla fuente siempre visible en desktop con `.sticky-source` y estática en móviles para evitar solapamientos, botón flotante y modal emergente de consulta rápida en teléfonos, sección de carga de dataset colapsable, Media ponderada por frecuencias, Mediana con Fi como GPS ordinal, Moda con diferencias delta 1 y delta 2, y fórmula madre de interpolación para Cuartiles Qk, Deciles Dk y Percentiles Pk; Caso aplicado para fijación de políticas de crédito (tasa preferencial P10, fiador obligatorio Q3 y aprobación especial P90); Soporte para tablas agrupadas personalizadas o datos crudos agrupados automáticamente, selección de unidades (Q, $, pts, min, h, años, kg, cm, und), selector gráfico (Histograma con marcas de estadígrafos + Ojiva porcentual acumulada), simulador dinámico de políticas de cartera, guía teórica con auto-quiz calificado al instante, y generador de Hoja de Trabajo oficial en PDF (jsPDF) con modo examen para autoevaluación honesta.
...
8. Semana 9 — Estadígrafos de Tendencia Central para Datos Agrupados y Medidas de Posición (+ Caso Cooperativa Pinulteco + Simulador de Políticas + PDF)
